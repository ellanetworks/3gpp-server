...
func TestN2HandoverCancelDuringPreparation(t *testing.T) {
...
func TestN2HandoverCancelAfterCommand(t *testing.T) {
...
func TestN2HandoverCancelThenReHandover(t *testing.T) {
...
func TestN2HandoverCancelNoHandoverInProgress(t *testing.T) {
...
// an Error Indication.
func TestN2HandoverCancelUnknownRanUeNgapID(t *testing.T) {
...
func TestN2HandoverCancelInconsistentAmfUeNgapID(t *testing.T) {
