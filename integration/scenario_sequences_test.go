...
func TestRegistration_MobilityUpdate(t *testing.T) {
...
func TestRegistration_PeriodicUpdate(t *testing.T) {
	gnbID := mustCreateGnB(t)
	ueID := mustCreateUE(t, gnbID)
...
func TestDeregistration_NonSwitchOff_Accept(t *testing.T) {
	gnbID := mustCreateGnB(t)
	ueID := mustCreateUE(t, gnbID)
...
func TestNGSetup_UnknownPLMN(t *testing.T) {
	body := `{
...
func TestRegistration_DuringSecurityMode(t *testing.T) {
	gnbID := mustCreateGnB(t)
	ueID := mustCreateUE(t, gnbID)
