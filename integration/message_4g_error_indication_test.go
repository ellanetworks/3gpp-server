...
// and leaves the receiver's reaction implementation-specific, so the only
// spec-grounded assertion is that the MME does not answer a valid Error
// Indication with an Error Indication of its own.
