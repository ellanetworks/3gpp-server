...
// connection.
func TestEPSMultiPDNConnect(t *testing.T) {
...
// identifier.
func TestEPSMultiPDNIPv6(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNDisconnect(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNConnectivityUnknownAPN(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
// PTI value".
func TestEPSPDNConnectivityInvalidPTI(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNConnectivityInvalidEBI(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNDisconnectInvalidPTI(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNDisconnectLastPDN(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSPDNConnectivityDuplicateAPN(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
