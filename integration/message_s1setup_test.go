...
func TestS1SetupHappyVariations(t *testing.T) {
	tests := []struct {
		name string
		body string
	}{
...
func TestS1SetupWrongPLMN(t *testing.T) {
	tests := []struct {
		name     string
		mcc, mnc string
	}{
...
func TestS1SetupMalformed(t *testing.T) {
...
// stayed on its feet.
func TestS1SetupResilience(t *testing.T) {
	seed := validS1SetupPDU(t)
...
func TestS1SetupPLMNFlex(t *testing.T) {
...
func TestS1SetupENBIDVariants(t *testing.T) {
	tests := []struct {
		name string
		kind s1ap.ENBIDKind
		id   uint32
...
func TestS1SetupSupportedTAs(t *testing.T) {
