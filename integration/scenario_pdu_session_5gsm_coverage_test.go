...
func TestPDUSessionEstablishment_AcceptMandatoryIEs(t *testing.T) {
...
// requested one.
func TestPDUSessionEstablishment_AlwaysOnIndication(t *testing.T) {
	gnbID := mustCreateGnB(t)
	ueID := mustCreateUE(t, gnbID)
	doRegistrationFlow(t, gnbID, ueID)
...
func TestPDUSessionModificationCommandReject_PTIMismatch(t *testing.T) {
	gnbID := mustCreateGnB(t)
...
func TestStatus5GSM_FromUE_SessionRemainsUsable(t *testing.T) {
	gnbID := mustCreateGnB(t)
	ueID := establishRegisteredUE(t, gnbID)
