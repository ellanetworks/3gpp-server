...
func TestPathSwitchRequestSuccess(t *testing.T) {
...
func TestPathSwitchRequestDuplicatePDUSessionIDsFailure(t *testing.T) {
...
func TestPathSwitchRequestSecurityCapabilityMismatchAcknowledged(t *testing.T) {
