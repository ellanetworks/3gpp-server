...
// Test4GScenarioDetach drives a UE-originating normal Detach after a full attach
...
// Test4GDetachSwitchOff drives a switch-off Detach and asserts the MME does NOT
