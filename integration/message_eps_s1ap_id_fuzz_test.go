...
func TestEPSUplinkNASTransportS1APIDFuzz(t *testing.T) {
...
func TestEPSUECapabilityInfoS1APIDFuzz(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
...
func TestEPSUEContextReleaseRequestS1APIDFuzz(t *testing.T) {
	enbID := mustCreateENB(t)
	ueID := mustCreateENBUE(t, enbID)
