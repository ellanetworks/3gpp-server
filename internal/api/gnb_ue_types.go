...
type SendGNBUENGAPRequest struct {
	...
	SwitchOff *uint8 `json:"switch_off,omitempty"`
	...
	RequestedNSSAI               []nas5gs.SNSSAIJSON `json:"requested_nssai,omitempty"`
...
type SendGNBUENGAPResponse struct {
	NGAP        *ngap.NGAPResponse  `json:"ngap,omitempty"`
	NAS         *nas5gs.NASResponse `json:"nas,omitempty"`
