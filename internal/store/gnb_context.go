...
func NewGNBContext(id, mcc, mnc, tac, gnbID string, gnbIDBitLength int, name string, sst int32, sd string, slices []SliceConfig) *GNBContext {
	return &GNBContext{
		ID:             id,
		MCC:            mcc,
		MNC:            mnc,
